...
<div class="educations-container">
  <h1 class="educations-title">Volunteer</h1>
  ...
  <div class="timeline-container">
    <div class="education-item right">
      ...
      <div class="education-card">
        <div class="card-header">
          <img src="./img/lds.jpg" alt="UET Logo" class="institution-logo">
          <div class="header-content">
            <span class="year-badge">2025 - Present</span>
        ...
        <div class="card-body">
          ...
          <p class="institution-location">New Campus, Lahore</p>
        </div>
      </div>
    </div>
    ...
    <div class="education-item left">
      ...
      <div class="education-card">
        <div class="card-header">
          <img src="./img/gdcs.jpg" alt="College Logo" class="institution-logo">
          <div class="header-content">
        ...
        <div class="card-body">
          <h3>Google Development Group of Campus UET</h3>
          <div class="highlight-bar"></div>
          <p class="institution-location">New Campus, Lahore</p>
        </div>
      </div>
    ...
    <div class="education-item right">
      ...
      <div class="education-card">
        <div class="card-header">
          <img src="./img/lds.jpg" alt="School Logo" class="institution-logo">
          <div class="header-content">
...
.education-item.left .timeline-dot {
  right: -10px;
}

.education-item.right .timeline-dot {
  left: -10px;
}
...
.education-content:hover .logo-glow {
  opacity: 1;
}
